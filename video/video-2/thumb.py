...
T = 8.4
W, H = 1080, 1920
TITLE = [["*ĐỪNG XIN PHÉP*", "NGƯỜI KHÁC"], ["ĐỂ SỐNG", "*CUỘC ĐỜI CỦA MÌNH*"]]
YELLOW, WHITE = (255, 198, 43), (255, 255, 255)

raw = subprocess.run([imageio_ffmpeg.get_ffmpeg_exe(), "-loglevel", "error", "-ss", str(T), "-i", f"{D}/v2/p2.mov",
...
img.save(f"{D}/v2/thumbnail.jpg", quality=95)
print("ok")
