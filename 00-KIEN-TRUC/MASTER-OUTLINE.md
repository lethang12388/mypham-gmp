# MASTER OUTLINE — Lộ trình toàn bộ bộ sách

> Bản đồ tổng thể của **MARKETING THỰC CHIẾN 2026–2035**. Đây là "hiến pháp" về cấu trúc: mọi chương mới phải nằm trong một tập, tuân theo template chương, và cập nhật trạng thái tại đây.
...
*Mục tiêu: xây nền tư duy đúng trước khi học kỹ thuật.*
...
## Nguyên tắc mở rộng outline

1. **Mọi chương mới** phải thuộc một tập hiện có hoặc một tập mới được khai báo tại đây trước.
2. Đặt tên file: `NN-slug-khong-dau.md` (ví dụ `03-marketing-mix.md`).
3. Chương phải theo đúng [`CHUONG-TEMPLATE.md`](CHUONG-TEMPLATE.md) — 24 mục + "Cần cập nhật trong tương lai".
4. Cập nhật trạng thái (⚪→🟡→🟢) tại bảng tương ứng ngay khi thay đổi.
5. Tuân thủ [`HUONG-DAN-CAP-NHAT.md`](HUONG-DAN-CAP-NHAT.md) về trích dẫn & phiên bản.

*Phiên bản outline: v1.0 · 2026*
